...
namespace Carz
{
    public class VideoInterpreter
    {
        ...
        public VideoInterpreter(string pathToVideoSource, string pathToXmlFile)
        {
            ...
            await Task.Run(() =>
            {
                ...
                for (; ; )
                {
                    ...
                    if (!iMatrix.IsEmpty)
                    {
                        ...
                        if (carsInFrame > numCarsInLot) for (int i = 0; i < carsInFrame - numCarsInLot; i++)  CarDidEnter.Invoke(this);
                        if (carsInFrame < numCarsInLot) for (int i = 0; i < numCarsInLot - carsInFrame; i++)  CarDidLeave.Invoke(DateTime.Now, this);
